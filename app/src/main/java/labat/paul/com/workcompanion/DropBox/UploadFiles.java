...
public class UploadFiles extends AsyncTask<Void, Long, Boolean> {
    ...
    public UploadFiles(@NonNull Context context, @NonNull DropboxAPI<?> api, String dropboxPath, File file){
        mContext = context;
    ...
    protected void onPostExecute(Boolean aBoolean) {
        mDialog.dismiss();
        if (aBoolean){
            Toast.makeText(mContext, "Ficher envoyé", Toast.LENGTH_SHORT).show();
        }else{
